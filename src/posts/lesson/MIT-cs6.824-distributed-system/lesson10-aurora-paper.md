...
- [Amazon Aurora：高吞吐量云原生关系数据库的设计考虑](#amazon-aurora高吞吐量云原生关系数据库的设计考虑)
  - [摘要](#摘要)
  - [1.介绍](#1介绍)
  - [2.大规模下的持久性](#2大规模下的持久性)
    - [2.1 复制与相关故障](#21-复制与相关故障)
    - [2.2 分段存储](#22-分段存储)
    - [2.3 弹性的操作优势](#23-弹性的操作优势)
  - [3.日志即数据库](#3日志即数据库)
    - [3.1 放大写入的负担](#31-放大写入的负担)
    - [3.2 将重做处理卸载到存储中](#32-将重做处理卸载到存储中)
    - [3.3 存储服务设计要点](#33-存储服务设计要点)
  - [4.日志稳步向前](#4日志稳步向前)
    - [4.1 解决方案概述：异步处理](#41-解决方案概述异步处理)
    - [4.2 正常操作](#42-正常操作)
      - [4.2.1 写入](#421-写入)
      - [4.2.2 提交](#422-提交)
      - [4.2.3 读](#423-读)
      - [4.2.4 Aurora复制](#424-aurora复制)
    - [4.3 恢复](#43-恢复)
  - [5.将所有内容整合在一起](#5将所有内容整合在一起)
  - [8.最近工作](#8最近工作)
  - [参考文章](#参考文章)
...
![图5：Aurora整体架构图](https://github.com/zgjsxx/static-img-repo/raw/main/blog/lesson/6.824/lesson10/paper/fig5-aurora-bird-view.png)
